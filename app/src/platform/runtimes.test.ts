...
describe("runtimeLabel", () => {
  it("names where a shell runs the way the owner thinks of it", () => {
    expect(runtimeLabel("windows")).toBe("Windows");
...
describe("distroOf", () => {
  it("is the distro of a WSL runtime, and nothing for Windows", () => {
