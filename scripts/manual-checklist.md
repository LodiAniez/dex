...
9. Tell an agent: "ask me a question about anything, but use a period instead of a question mark." It still shows **needs you**, and the line under its desk shows the question in blue. Answer it; when it finishes, the line under its desk shows its closing words in plain italics, and it wanders off.
