...
- **Cards** — one card each, and the card *is* that agent's screen: their terminal, live, under their name and status. Below it, on the card itself: a box to prompt them (Enter sends, Shift+Enter is a new line), **Go to pane**, **Details** (who they report to, what they have done, a memo) and **Clock out**. An agent that needs you says what for across the top of its card. Nothing pops open when you click a card.
